...
import MinusIcon from "@modules/common/icons/minus"; // Updated to match the actual file name
import CounterPlusIcon from "@modules/common/icons/counter-plus-icon";

...
const FiltersSidebar = ({ sortBy = "created_at", search = false }: FiltersSidebarProps) => {
  ...
  return (
    <aside className="hidden lg:block w-96 pr-8 flex-shrink-0">
      <div className="sticky top-6 bg-white p-6 rounded-lg shadow-sm border border-gray-100">
        <nav className="pb-6 border-b border-gray-100">
          <ol className="flex items-center space-x-2 text-sm">
            <li className="text-gray-600 hover:text-gray-800 transition-colors duration-200">
        ...
        <section className="pt-6 pb-6 border-b border-gray-100">
